...
def vae_model(path,original_dim,xtrain,xtest,intermediate_dim,batch_size,latent_dim,epochs):
    # network parameters
    ...
    outputs = Dense(original_dim, name='decoder_mu', activation='sigmoid')(x)
